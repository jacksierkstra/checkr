...
describe("validateType step", () => {
  ...
  describe("additional built-in types", () => {
    it.each([
      ...
      // New types
      ["xs:Name", "valid:Name", true],
      ["xs:Name", "1invalid", false],
      ["xs:language", "en", true],
      ["xs:language", "en-GB", true],
      ["xs:language", "zh-Hant-TW", true],
      ["xs:language", "not valid!", false],
      ["xs:NMTOKENS", "foo bar baz", true],
      ["xs:NMTOKENS", "foo", true],
      ["xs:NMTOKENS", "foo bar!", false],
      ["xs:duration", "P1Y2M3DT4H5M6S", true],
      ["xs:duration", "PT30S", true],
      ["xs:duration", "P1Y", true],
      ["xs:duration", "not-duration", false],
      ["xs:gYear", "2024", true],
      ["xs:gYear", "2024Z", true],
      ["xs:gYear", "abc", false],
      ["xs:gYearMonth", "2024-01", true],
      ["xs:gYearMonth", "2024-1", false],
      ["xs:gMonth", "--03", true],
      ["xs:gMonth", "-03", false],
      ["xs:gDay", "---15", true],
      ["xs:gDay", "--15", false],
      ["xs:gMonthDay", "--03-15", true],
      ["xs:gMonthDay", "03-15", false],
      ["xs:hexBinary", "DEADBEEF", true],
      ["xs:hexBinary", "deadbeef", true],
      ["xs:hexBinary", "DEF", false],
      ["xs:hexBinary", "GG", false],
      ["xs:base64Binary", "SGVsbG8=", true],
      ["xs:base64Binary", "SGVsbG8gV29ybGQ=", true],
      ["xs:base64Binary", "!!!not-base64!!!", false],
