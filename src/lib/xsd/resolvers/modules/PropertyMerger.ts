...
export class PropertyMerger implements IPropertyMerger {
  ...
  mergeTypeDefinition(element: XSDElement, typeDef: XSDElement): XSDElement {
    ...
    result.minInclusive =
      element.minInclusive !== undefined ? element.minInclusive : typeDef.minInclusive;
    result.maxInclusive =
      element.maxInclusive !== undefined ? element.maxInclusive : typeDef.maxInclusive;
    result.minExclusive =
      element.minExclusive !== undefined ? element.minExclusive : typeDef.minExclusive;
    result.maxExclusive =
      element.maxExclusive !== undefined ? element.maxExclusive : typeDef.maxExclusive;
