  ...
  describe("Property preservation", () => {
    ...
    it("should preserve existing choices if type has no choices", () => {
      ...
      const element: XSDElement = {
        name: "root",
        type: "NoChoiceType",
        choices: [{ elements: [{ name: "existingChoice", type: "xsd:string" }] }],
      };
    ...
    it("should resolve colon-prefixed type names correctly using global types", () => {
      const schema: XSDSchema = {
        ...
        types: {
          SimpleType: {
            name: "SimpleType",
            children: [{ name: "prefixedChild", type: "xsd:string" }],
          },
        },
      };
      ...
      expect(resolved.children).toEqual([{ name: "prefixedChild", type: "xsd:string" }]);
    });
  });
    ...
    it("should recursively resolve nested type references using global types", () => {
      const schema: XSDSchema = {
        ...
        types: {
          TypeA: {
            name: "TypeA",
            children: [{ name: "child1", type: "TypeB" }],
          },
          TypeB: {
            name: "TypeB",
            children: [{ name: "grandchild", type: "xsd:string" }],
          },
        },
      };
    ...
    it("should handle nested elements with mixed resolutions using global types", () => {
      const schema: XSDSchema = {
        ...
        types: {
          ParentType: {
            name: "ParentType",
            children: [{ name: "child1", type: "ChildType" }],
          },
          ChildType: {
            name: "ChildType",
            children: [{ name: "grandchild", type: "xsd:string" }],
      ...
      const schema: XSDSchema = {
        ...
        types: {
          ComplexType: {
            name: "ComplexType",
            children: [{ name: "child", type: "xsd:string" }],
            choices: [{ elements: [{ name: "option", type: "xsd:string" }] }],
          },
        },
      };
  ...
  describe("Extension and Restriction", () => {
    it("should resolve extension type with base type", () => {
      const schema: XSDSchema = {
        ...
        types: {
          BaseType: {
            name: "BaseType",
            children: [{ name: "baseChild", type: "xsd:string" }],
            attributes: [{ name: "baseAttr", type: "xsd:string" }],
          },
        },
      };
      ...
      const element: XSDElement = {
        ...
        extension: {
          base: "BaseType",
          children: [{ name: "extChild", type: "xsd:string" }],
          attributes: [{ name: "extAttr", type: "xsd:string" }],
        },
      };
    ...
    it("should handle extension attribute collisions by preferring extension attributes", () => {
      const schema: XSDSchema = {
        ...
        types: {
          BaseType: {
            name: "BaseType",
            attributes: [{ name: "attr", type: "xsd:string", use: "optional" }],
          },
        },
      };
      ...
      const element: XSDElement = {
        ...
        extension: {
          base: "BaseType",
          attributes: [{ name: "attr", type: "xsd:string", use: "required" }],
        },
      };
    ...
    it("should handle nested extensions correctly", () => {
      const schema: XSDSchema = {
        ...
        types: {
          ...
          MiddleType: {
            ...
            extension: {
              base: "BaseType",
              children: [{ name: "middleChild", type: "xsd:string" }],
            },
          },
        },
      };
      ...
      const element: XSDElement = {
        ...
        extension: {
          base: "MiddleType",
          children: [{ name: "leafChild", type: "xsd:string" }],
        },
      };
      ...
      const schema: XSDSchema = {
        ...
        types: {
          Type1: {
            ...
            children: [{ name: "child1", type: "xsd:string" }],
          },
        },
      };
      ...
      const complexSchema: XSDSchema = {
        ...
        types: {
          ...
          ChildType: {
            ...
            extension: {
              base: "BaseType",
              children: [{ name: "childChild", type: "xsd:string" }],
            },
          },
          StringType: {
            name: "StringType",
